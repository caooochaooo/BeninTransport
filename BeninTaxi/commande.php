<?php
	...
	if(mysqli_num_rows($query)===1)
	{
		if($query)
		{
			...
			$record=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM reservation WHERE conducid='{$conducid}' ORDER BY id DESC"));
			$query1=mysqli_query($conn,"SELECT * FROM reservation WHERE conducid='{$conducid}' ORDER BY id DESC limit $start,$perpage");
...
<body>
		...
		<div>
			<ul id="navbar">
				...
				<li><a href="messagerie.php">Historiques des trajets</a>
					<?php if($row['account']=='conducteur'){echo "<ul  class='submenu'><li><a class='active' href='commande.php'>Commandes recus</a></li>
	...
	<section class="historique">
		<h2 style="padding-bottom:50px">Historiques des commandes recus</h2>
		<div class="hh">
			<h4>Date</h4>
		...
		<div class="hset">
			...
			<div style="background-color:<?php if(($row1['reservalid']==='1')){echo "#008000";}?>">
